...
python lens.py status | history | memory | review
```

كل أمر بيمر بـ: تحميل السياق والذاكرة ← خطة ← تنفيذ ← اختبار ← مراجعة ذاتية
← استخراج تعلّم ← حفظ ← تقرير أمين. والتنفيذ التالي بيقرأ تعلّم اللي قبله.
التفاصيل: `docs/LENS_OPERATOR.md` · القواعد: `AGENTS.md`.
...
> 🎯 ولو الموديل نجح في المطلوب وكمّل لف بعدها: الإيجنت بيوقفه ويسلّمك الناتج الناجح (v2.9+).
